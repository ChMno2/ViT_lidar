...
def get_args_parser():
    ...
    parser.add_argument('--project', default='RepFormer', type=str,
...
def main(args):
    ...
    steps_per_epoch = len(dataset_train) // total_batch_size
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if test_stats["acc1"] > max_accuracy:
                # ckpt_path = os.path.join(output_dir, 'best_checkpoint_'+str(epoch)+'.pth')
